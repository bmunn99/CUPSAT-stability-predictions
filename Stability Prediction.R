...
df <- read.csv("/Users/bmunn99/Desktop/Alignments/CUPSAT predictions.csv", sep = ',', header = TRUE)
...
plot
# Save the plot
ggsave("/Users/bmunn99/Desktop/Alignments/CUPSAT Predictions AGO3.png", plot, width = 10, height = 10, dpi = 300)
...
plot2
# Save the plot
ggsave("/Users/bmunn99/Desktop/Alignments/CUPSAT 225.png", plot2, width = 10, height = 10, dpi = 300)
...
plot3
# Save the plot
ggsave("/Users/bmunn99/Desktop/Alignments/CUPSAT 507.png", plot3, width = 10, height = 10, dpi = 300)
...
plot4
# Save the plot
ggsave("/Users/bmunn99/Desktop/Alignments/CUPSAT 638.png", plot4, width = 10, height = 10, dpi = 300)
